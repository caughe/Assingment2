...
def service_new(request):
    if request.method == "POST":
        ...
        form = ServiceForm()
        # print("Else")
    return render(request, 'crm/service_new.html',
                  {'form': form})
...
def service_edit(request, pk):
    ...
    return render(request, 'crm/service_edit.html',
                  {'form': form})
...
# ADDED ADD NEW PRODUCT FUNCTION
@login_required
def product_add(request):
    if request.method == "POST":
        ...
        form = ProductForm()
        # print("Else")
    return render(request, 'crm/product_add.html',
                  {'form': form})
...
def edit_product(request, pk):
    ...
    return render(request, 'crm/edit_product.html',
                  {'form': form})
...
# 2
@login_required
def delete_product2(request, pk):
    product = get_object_or_404(Product, pk=pk)
    product.delete()
    return redirect('crm:service_list')

...
urlpatterns = [
    ...
    # ADDED DELETE URL REFERENCE
    path('service/<int:pk>/delete/', views.service_delete, name='service_delete'),

    # ADDED ADD PRODUCT URL REFERENCE
    path('product/create/', views.product_add, name='add_product'),

    # ADDED EDIT PRODUCT URL REFERENCE
    path('product/<int:pk>/edit/', views.edit_product, name='edit_product'),

    # ADDED DELETE PRODUCT URL REFERENCE
